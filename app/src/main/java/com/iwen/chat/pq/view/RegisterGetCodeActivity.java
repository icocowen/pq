...
public class RegisterGetCodeActivity extends PQBaseActivity {
            ...
            switch (msg.what) {
                case SUCCESS:
                    ...
                    if (Objects.equals(obj.get("code"), 200)) {
                        Util.showToast(RegisterGetCodeActivity.this, (String) obj.get("data"));

                        //成功
                        new Handler().postDelayed((Runnable) () -> {
                            Intent intent = new Intent(RegisterGetCodeActivity.this, RegisterGetCode2Activity.class);
                        ...
                        //失败
                        Util.showToast(RegisterGetCodeActivity.this, (String) obj.get("message"));
                ...
                case FAILURE:
                    ...
                    Util.showToast(RegisterGetCodeActivity.this, data.getString("message"));
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.register_getcode_activity);
        ButterKnife.bind(this);

        StatusBarUtil.setRootViewFitsSystemWindows(this, true);
        StatusBarUtil.setStatusBarDarkTheme(this, true);
        TitleBar titleBar = findViewById(R.id.registerGetCodeTitleBar);
    ...
    public void onNextlicked() {
        ...
        if (!StrUtil.isEmpty(emailStr)) {
            ...
            if (isMatch) {
                instance.registerSendEmail(handler,UserManagement.USER_VERIFY_CODE,emailStr);
            }else {
                Util.showToast(RegisterGetCodeActivity.this, "邮箱地址格式错误");
            }
        }else {
            Util.showToast(RegisterGetCodeActivity.this, "请输入邮箱地址");
        }
    }
}
